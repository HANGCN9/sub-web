...
export default {
    ...
    var data = {
      ...
      options: {
        ...
        customBackend: {
          ...
          "now-subconverter-one-indol.vercel.app": "now-subconverter-one-indol.vercel.app?",
        ...
        backendOptions: [
          ...
          { value: "https://now-subconverter-one-indol.vercel.app?" },
  ...
  mounted() {
    ...
    this.form.customBackend = "https://now-subconverter-one-indol.vercel.app/sub?";
